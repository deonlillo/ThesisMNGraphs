...
# -------------------------------- KEYSTONE INDIVIDUAL REMOVAL ------------------------------------------

G.remove_node(23) # Keystone individual and EM colonized tree

em_trees_new = em_trees - 1
...
print("\nGRAPH METRICS AFTER KEYSTONE INDIVIDUAL REMOVAL:")
print("Total EM Colonized Trees:", em_trees_new)
print("Total Links:", len(G.edges))
G_mnd = calc_mean_node_degree(G)
print("Mean Node Degree:", G_mnd)
