...
# -------------------------------------------- PLOT 4 KEYSTONE INDIVIDUAL REMOVAL ---------------------------------------------

plot_4_G.remove_node(1) # keystone individual
...
print("\nPLOT 4 AFTER KEYSTONE INDIVIDUAL REMOVAL:")
print("Total linked nodes:", len(plot_4_G.nodes) - len(iso_verts))
print("Total links:", len(plot_4_G.edges))
plot_4_G_mnd = calc_mean_node_degree(plot_4_G)
print("Mean Node Degree:", plot_4_G_mnd)
plot_4_G_cc = nx.average_clustering(plot_4_G)
